...
export class AppMenuitemComponent implements OnInit, OnDestroy {
  ...
  itemClick(event: Event) {
    ...
    if (this.item.items) {
      ...
      // hide overlay menus
      this.templateComponent.menuActiveMobile = false;

      if (
        this.templateComponent.isDesktop() &&
        this.templateComponent.isOverlay()
      ) {
        this.templateComponent.menuInactiveDesktop = true;
      }
    }
  }
